		...
		<div class="container-fluid" v-cloak>
			<div class="row">
				...
				<div class='authCalc col-lg-6 col-md-6 col-sm-10 col-xs-12'>
					...
					<div v-if="show">
						<div class="row addSpace">
							<div class='col-lg-2 col-md-2 col-sm-4 col-xs-4'>Перевести</div>
							<div class='col-lg-3 col-md-3 col-sm-6 col-xs-6'>
								<select v-model="first">
									<option v-for="var1 in elements" :value="var1">{{ var1.name }}</option>
								</select>
							</div>
						</div>
						<div class="row addSpace">
							<div class='text-center col-lg-2 col-md-1 col-sm-4 col-xs-4'>в</div>
							<div class='col-lg-4 col-md-4 col-sm-6 col-xs-6'>
								<select v-model="second">
									<option v-for="var2 in elements" :value="var2">{{ var2.name }}</option>
								</select>
							</div>
						</div>
						<div class="row addSpace">
							<div class='col-lg-2 col-md-2 col-sm-4 col-xs-4'>кількість:</div>
							<div class='col-lg-3 col-md-3 col-sm-6 col-xs-6'>
				...
				<div class="col-lg-3 col-md-3 col-sm-10 col-xs-12">
					...
					<? else :?>
					<h5 class="text-center">Коментарів <?= $comment->rowCount()?></h5>
					    <?php foreach ($comment as $item) :?>
					        <p class='text-left ip_Comment'><?=$item['nik'] ?> :</p>
					        <p class="news_Comment"><?=$item['text'] ?></p><br>
					    <?php endforeach; ?>
					<? endif; ?>
				</div>
			</div>
